...
const PRODUCTS = {
  ...
  "az-sober-living": { title: "Sober Living Home Operations Policy & Procedure Manual", file: "AZ Sober Living Home Operations Manual.docx" },
  ...
  "oh-recovery-residence": { title: "Recovery Residence Operations Policy & Procedure Manual (Ohio)", file: "OH Recovery Residence Operations Manual.docx" },
  "fl-recovery-residence": { title: "Recovery Residence Operations Policy & Procedure Manual (Florida)", file: "FL Recovery Residence Operations Manual.docx" },
  "tx-recovery-residence": { title: "Recovery Residence Operations Policy & Procedure Manual (Texas)", file: "TX Recovery Residence Operations Manual.docx" },
  "tx-open-recovery-residence": { title: "How to Open a Recovery Residence (Sober Living Home) in Texas", file: "How_to_Open_a_Recovery_Residence_in_Texas.pdf" },
  "tx-recovery-residence-referral": { title: "The Recovery Residence Referral System (Texas Edition)", file: "The_Recovery_Residence_Referral_System_Texas_Edition.docx" },
